...
<head>
    ...
    <title>Noorflexi Admin: <?php echo ($title) ? $title : '';?></title>
    ...
    <!-- Morris chart -->
    <link rel="stylesheet" href="<?php echo base_url();?>resource/admin/bower_components/morris.js/morris.css">
    <!-- jvectormap -->
    <link rel="stylesheet" href="<?php echo base_url();?>resource/admin/bower_components/jvectormap/jquery-jvectormap.css">
    <!-- Date Picker -->
    <link rel="stylesheet" href="<?php echo base_url();?>resource/admin/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
