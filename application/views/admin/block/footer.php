<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2016 <a href="<?php echo base_url();?>">Almsaeed Studio</a>.</strong> All rights
    reserved.
</footer>
...
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo base_url();?>resource/admin/bower_components/jquery-ui/jquery-ui.min.js"></script>
...
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url();?>resource/admin/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="<?php echo base_url();?>resource/admin/bower_components/moment/min/moment.min.js"></script>
<script src="<?php echo base_url();?>resource/admin/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="<?php echo base_url();?>resource/admin/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo base_url();?>resource/admin/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
<script src="<?php echo base_url();?>resource/admin/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
