...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="ezttle"><span class="text">Refund Action</span></div>
    </section>
                        ...
                        <div class="col-md-12 fleft">
                            <div class="row">
                                <div class="col-md-6 col-sm-6 col-xs-12" style="min-width:370px;margin-right:50px">
                                    <form action="<?php echo base_url();?>admin/refund/" role="form" class="inform well" style="width:350px;" method="post" accept-charset="utf-8">
